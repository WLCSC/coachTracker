...
class SportsControllerTest < ActionController::TestCase
  ...
  test "should create sport" do
    assert_difference('Sport.count') do
      post :create, sport: { end_date: @sport.end_date, name: @sport.name, role_id: @sport.role_id, short: @sport.short, start_date: @sport.start_date }
    end
  ...
  test "should update sport" do
    patch :update, id: @sport, sport: { end_date: @sport.end_date, name: @sport.name, role_id: @sport.role_id, short: @sport.short, start_date: @sport.start_date }
    assert_redirected_to sport_path(assigns(:sport))
  end
