...
class CertificationsControllerTest < ActionController::TestCase
  ...
  test "should create certification" do
    assert_difference('Certification.count') do
      post :create, certification: { course_id: @certification.course_id, person_id: @certification.person_id, year_id: @certification.year_id }
    end
  ...
  test "should update certification" do
    patch :update, id: @certification, certification: { course_id: @certification.course_id, person_id: @certification.person_id, year_id: @certification.year_id }
    assert_redirected_to certification_path(assigns(:certification))
  end
